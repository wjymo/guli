...
//    List<RiskDeDeviceWarnVo>
    ...
    @Insert("insert into de_device_warn_test_dis " +
            " (alarm_type,org,from_id,alarm_time,create_date) " +
            " values " +
            " (#{alarmType},#{org},#{fromId},#{alarmTime},#{createDate})")
    @Options(useGeneratedKeys=true, keyProperty="id", keyColumn="id")
    Integer insertByDisTest(DeviceWarn deviceWarn);
}
